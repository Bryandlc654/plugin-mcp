		...
		return JsonRpc::success(
			...
			array(
				...
				'instructions'    => sprintf(
					__( 'You are connected to the WordPress site %s via WP MCP Connect. Use the available wp_* tools to help the user manage their WordPress content. Respect the user\'s capabilities and always ask before destructive actions.', 'wp-mcp-connect' ),
					get_bloginfo( 'name' )
				),
			)
		);
