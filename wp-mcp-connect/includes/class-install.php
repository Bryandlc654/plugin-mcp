...
final class Install {
	...
	const OPTION_DB  = 'wp_mcp_connect_db_version';

	public static function activate() {
		self::create_tables();
		self::ensure_settings();
		update_option( 'wp_mcp_connect_flush_rewrite', 1 );
	}
	...
	public static function uninstall() {
		...
		delete_option( 'wp_mcp_connect_flush_rewrite' );
	}
	...
	public static function maybe_upgrade() {
		...
		self::ensure_tables();
		if ( get_option( 'wp_mcp_connect_flush_rewrite' ) ) {
			flush_rewrite_rules();
			delete_option( 'wp_mcp_connect_flush_rewrite' );
		}
	}
	...
	public static function ensure_tables() {
		global $wpdb;
		$existing = $wpdb->get_col( "SHOW TABLES LIKE '" . $wpdb->prefix . 'wp_mcp_connect\_%' . "'" );
	...
	public static function table( $name ) {
		global $wpdb;
		return $wpdb->prefix . 'wp_mcp_connect_' . $name;
	}
