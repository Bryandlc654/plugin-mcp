...
return array(
	...
	array(
		...
		'description' => __( 'Gets general information about the WordPress site: name, URL, description, WordPress version, language, timezone, and the connected user. Use this tool first when you need context about the site.', 'mcp-connect-wp' ),
		'scope'       => 'site:read',
		'category'    => 'site',
		'mode'        => 'read',
		'inputSchema' => array(
			'type'                 => 'object',
			'properties'           => array(
				'include_capabilities' => array( 'type' => 'boolean', 'default' => true, 'description' => __( 'Include the connected user\'s relevant capabilities.', 'mcp-connect-wp' ) ),
			),
			'additionalProperties' => false,
		),
		'permission'  => function ( $args, $actor ) {
			if ( ! Permissions::user_has( $actor['user_id'], 'read' ) ) {
				return array( 'allowed' => false, 'code' => 'insufficient_permissions', 'message' => __( 'The account has no read access to this site.', 'mcp-connect-wp' ) );
			}
