 ...
 * Plugin URI:        https://github.com/wpmcpconnect/mcp-connect-wp
...
define( 'MCP_CONNECT_FILE', __FILE__ );
define( 'MCP_CONNECT_DIR', plugin_dir_path( __FILE__ ) );
define( 'MCP_CONNECT_URL', plugin_dir_url( __FILE__ ) );
define( 'MCP_CONNECT_MIN_CAP', 'manage_options' );

require_once MCP_CONNECT_DIR . 'includes/class-plugin.php';
...
register_activation_hook( __FILE__, array( '\MCPConnect\Install', 'activate' ) );
register_deactivation_hook( __FILE__, array( '\MCPConnect\Install', 'deactivate' ) );
